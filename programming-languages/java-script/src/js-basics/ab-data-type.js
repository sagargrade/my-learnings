...
let intValue = 10; 
let realValue = 0.10;
console.log(`Value of integer variable is ${intValue} and real variable is ${realValue}`);

//String ("", '')
let doubleQuoteString = "Double Quote String";
let singleQuoteString = 'Single Quote String';
console.log(`Value of double quote string is ${doubleQuoteString} and single quote string is ${singleQuoteString}`);
...
console.log(`Content of section 1 of chapter 1 is ${book.contents?.ch01?.sec01}`); //Conditional access property
